...
const Draft = ({ navigation }) => {
    ...
    useEffect(() => {
        if (postListLineRunData) {
            const filteredData = postListLineRunData.filter(item => item.Status === 'Draft');
                            ...
                            <View style={IntegrationListLineStyles.iconContainer}>
                                <View style={IntegrationListLineStyles.iconWithText}>
                                    <TouchableOpacity style={IntegrationListLineStyles.iconButton} onPress={() => handleViewPress(item)}>
                                        <AntDesign name="eye" size={15} color="green" />
                                        <Text style={IntegrationListLineStyles.viewText}>View</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                        ) : item.Status === 'Draft' ? (
